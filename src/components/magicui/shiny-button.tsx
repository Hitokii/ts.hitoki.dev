...
const ShinyButton = ({ text = "shiny-button" }) => {
  return (
    ...
    >
      <span
        className="relative block h-full w-full text-5xl p-4 lg:p-1 lg:text-base uppercase tracking-wide text-[rgb(0,0,0,65%)] dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
